...
export default function Webpage() {
  return (
    ...
    <div>
        <section className="home-slider owl-carousel img" style="background-image: url(images/bg_1.jpg);">
    ...
    <section className="ftco-about d-md-flex">
    	<div className="one-half img" style="background-image: url(images/about.jpg);"></div>
    ...
    <section className="ftco-section">
    		...
    		<div className="row no-gutters d-flex">
    			<div className="col-lg-4 d-flex ftco-animate">
    				<div className="services-wrap d-flex">
    					<a href="#" className="img" style="background-image: url(images/pizza-1.jpg);"></a>
    			...
    			<div className="col-lg-4 d-flex ftco-animate">
    				<div className="services-wrap d-flex">
    					<a href="#" className="img" style="background-image: url(images/pizza-2.jpg);"></a>
    					<div className="text p-4">
    						<h3>Greek Pizza</h3>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
    						<p className="price"><span>$2.90</span> <a href="#" className="ml-2 btn btn-white btn-outline-white">Order</a></p>
    			...
    			<div className="col-lg-4 d-flex ftco-animate">
    				<div className="services-wrap d-flex">
    					<a href="#" className="img" style="background-image: url(images/pizza-3.jpg);"></a>
    					<div className="text p-4">
    			...
    			<div className="col-lg-4 d-flex ftco-animate">
    				<div className="services-wrap d-flex">
    					<a href="#" className="img order-lg-last" style="background-image: url(images/pizza-4.jpg);"></a>
    					<div className="text p-4">
    			...
    			<div className="col-lg-4 d-flex ftco-animate">
    				<div className="services-wrap d-flex">
    					<a href="#" className="img order-lg-last" style="background-image: url(images/pizza-5.jpg);"></a>
    					<div className="text p-4">
    						<h3>Tomatoe Pie</h3>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
    						<p className="price"><span>$2.90</span> <a href="#" className="ml-2 btn btn-white btn-outline-white">Order</a></p>
    			...
    			<div className="col-lg-4 d-flex ftco-animate">
    				<div className="services-wrap d-flex">
    					<a href="#" className="img order-lg-last" style="background-image: url(images/pizza-6.jpg);"></a>
    					<div className="text p-4">
    						<h3>Margherita</h3>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
    						<p className="price"><span>$2.90</span> <a href="#" className="ml-2 btn btn-white btn-outline-white">Order</a></p>
        ...
        <div className="row">
        	<div className="col-md-6">
        		...
        		<div className="pricing-entry d-flex ftco-animate">
        			<div className="img" style="background-image: url(images/pizza-2.jpg);"></div>
        			<div className="desc pl-3">
	        			<div className="d-flex text align-items-center">
        		...
        		<div className="pricing-entry d-flex ftco-animate">
        			<div className="img" style="background-image: url(images/pizza-3.jpg);"></div>
        			<div className="desc pl-3">
	        			<div className="d-flex text align-items-center">
        		...
        		<div className="pricing-entry d-flex ftco-animate">
        			<div className="img" style="background-image: url(images/pizza-4.jpg);"></div>
        			<div className="desc pl-3">
	        			<div className="d-flex text align-items-center">
        	...
        	<div className="col-md-6">
        		...
        		<div className="pricing-entry d-flex ftco-animate">
        			<div className="img" style="background-image: url(images/pizza-6.jpg);"></div>
        			<div className="desc pl-3">
	        			<div className="d-flex text align-items-center">
        		...
        		<div className="pricing-entry d-flex ftco-animate">
        			<div className="img" style="background-image: url(images/pizza-7.jpg);"></div>
        			<div className="desc pl-3">
	        			<div className="d-flex text align-items-center">
        		...
        		<div className="pricing-entry d-flex ftco-animate">
        			<div className="img" style="background-image: url(images/pizza-8.jpg);"></div>
        			<div className="desc pl-3">
	        			<div className="d-flex text align-items-center">
    	...
    	<div className="container-wrap">
    		<div className="row no-gutters">
					<div className="col-md-3 ftco-animate">
						<a href="#" className="gallery img d-flex align-items-center" style="background-image: url(images/gallery-1.jpg);">
					...
					<div className="col-md-3 ftco-animate">
						<a href="#" className="gallery img d-flex align-items-center" style="background-image: url(images/gallery-2.jpg);">
							<div className="icon mb-4 d-flex align-items-center justify-content-center">
    						<span className="icon-search"></span>
    					</div>
						</a>
					...
					<div className="col-md-3 ftco-animate">
						<a href="#" className="gallery img d-flex align-items-center" style="background-image: url(images/gallery-3.jpg);">
							<div className="icon mb-4 d-flex align-items-center justify-content-center">
    						<span className="icon-search"></span>
    					</div>
						</a>
					...
					<div className="col-md-3 ftco-animate">
						<a href="#" className="gallery img d-flex align-items-center" style="background-image: url(images/gallery-4.jpg);">
							<div className="icon mb-4 d-flex align-items-center justify-content-center">
    						<span className="icon-search"></span>
    					</div>
						</a>
    ...
    <section className="ftco-menu">
    	<div className="container-fluid">
    		<div className="row d-md-flex">
	    		<div className="col-lg-4 ftco-animate img f-menu-img mb-5 mb-md-0" style="background-image: url(images/about.jpg);">
	    		</div>
		            ...
		            <div className="tab-content ftco-animate" id="v-pills-tabContent">
		              	...
		              	<div className="row">
		              		<div className="col-md-4 text-center">
		              			<div className="menu-wrap">
		              				<a href="#" className="menu-img img mb-4" style="background-image: url(images/pizza-1.jpg);"></a>
		              				<div className="text">
		              		...
		              		<div className="col-md-4 text-center">
		              			<div className="menu-wrap">
		              				<a href="#" className="menu-img img mb-4" style="background-image: url(images/pizza-2.jpg);"></a>
		              				<div className="text">
		              					<h3><a href="#">Itallian Pizza</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p className="price"><span>$2.90</span></p>
		              		...
		              		<div className="col-md-4 text-center">
		              			<div className="menu-wrap">
		              				<a href="#" className="menu-img img mb-4" style="background-image: url(images/pizza-3.jpg);"></a>
		              				<div className="text">
		              					<h3><a href="#">Itallian Pizza</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p className="price"><span>$2.90</span></p>
		              ...
		              <div className="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab">
		                <div className="row">
		              		<div className="col-md-4 text-center">
		              			<div className="menu-wrap">
		              				<a href="#" className="menu-img img mb-4" style="background-image: url(images/drink-1.jpg);"></a>
		              				<div className="text">
		              		...
		              		<div className="col-md-4 text-center">
		              			<div className="menu-wrap">
		              				<a href="#" className="menu-img img mb-4" style="background-image: url(images/drink-2.jpg);"></a>
		              				<div className="text">
		              		...
		              		<div className="col-md-4 text-center">
		              			<div className="menu-wrap">
		              				<a href="#" className="menu-img img mb-4" style="background-image: url(images/drink-3.jpg);"></a>
		              				<div className="text">
		              ...
		              <div className="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-3-tab">
		                <div className="row">
		              		<div className="col-md-4 text-center">
		              			<div className="menu-wrap">
		              				<a href="#" className="menu-img img mb-4" style="background-image: url(images/burger-1.jpg);"></a>
		              				<div className="text">
		              					<h3><a href="#">Itallian Pizza</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p className="price"><span>$2.90</span></p>
		              		...
		              		<div className="col-md-4 text-center">
		              			<div className="menu-wrap">
		              				<a href="#" className="menu-img img mb-4" style="background-image: url(images/burger-2.jpg);"></a>
		              				<div className="text">
		              					<h3><a href="#">Itallian Pizza</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p className="price"><span>$2.90</span></p>
		              		...
		              		<div className="col-md-4 text-center">
		              			<div className="menu-wrap">
		              				<a href="#" className="menu-img img mb-4" style="background-image: url(images/burger-3.jpg);"></a>
		              				<div className="text">
		              					<h3><a href="#">Itallian Pizza</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p className="price"><span>$2.90</span></p>
		              ...
		              <div className="tab-pane fade" id="v-pills-4" role="tabpanel" aria-labelledby="v-pills-4-tab">
		                <div className="row">
		              		<div className="col-md-4 text-center">
		              			<div className="menu-wrap">
		              				<a href="#" className="menu-img img mb-4" style="background-image: url(images/pasta-1.jpg);"></a>
		              				<div className="text">
		              					<h3><a href="#">Itallian Pizza</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p className="price"><span>$2.90</span></p>
		              		...
		              		<div className="col-md-4 text-center">
		              			<div className="menu-wrap">
		              				<a href="#" className="menu-img img mb-4" style="background-image: url(images/pasta-2.jpg);"></a>
		              				<div className="text">
		              					<h3><a href="#">Itallian Pizza</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p className="price"><span>$2.90</span></p>
		              		...
		              		<div className="col-md-4 text-center">
		              			<div className="menu-wrap">
		              				<a href="#" className="menu-img img mb-4" style="background-image: url(images/pasta-3.jpg);"></a>
		              				<div className="text">
		              					<h3><a href="#">Itallian Pizza</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p className="price"><span>$2.90</span></p>
